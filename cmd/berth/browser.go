...
import (
	...
	browserpkg "github.com/0x666c6f/berth/pkg/browser"
...
func init() {
	browserCaptureCmd.Flags().StringVar(&browserOutDir, "out", "", "Output directory; defaults to ~/.berth/state/browser/<timestamp>")
