...
- Backend channel: `SAFE_AG_LIVE_QA=1 go test -tags livespike ./internal/svc/` — 11/11 subtests green against real VM + disposable container; attach spike also green against a background-spawned no-repo agent.
